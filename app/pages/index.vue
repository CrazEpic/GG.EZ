<template>
	<div class="flex flex-col relative">
		<LandingScreen v-if="modalType == 'LANDING_SCREEN'" @close_modal="closeModal" class="absolute top-0 left-0 w-full h-full min-h-fit z-10"></LandingScreen>
		...
		<RegionModalPiltoverZaunModal v-if="modalType == 'PILTOVER_ZAUN'" @close_modal="closeModal" class="absolute top-0 left-0 w-full h-full z-10 min-h-fit"></RegionModalPiltoverZaunModal>
